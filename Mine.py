...
SIZE = 50
NUM_OF_BOMBS = 30
NUM_OF_LEFT_BOMBS = NUM_OF_BOMBS
EMPTY = 0
BOMB = 1
OPENED = 2
EMPTY_FLAG = 3
...
def main():
    ...
    while True:
        ...
        message_score = smallfont.render("BOMB = {}".format(NUM_OF_LEFT_BOMBS), True, (0, 255, 255))
        message_time = smallfont.render("TIME = {}".format(int(seconds)), True, (0, 255, 255))
